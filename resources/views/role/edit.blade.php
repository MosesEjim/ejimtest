              ...
              <form method="post" action="{{ route('dashboard.role.update', $role->id) }}">
                  ...
                  <div class="preview">
                      <div>
                          ...
                          <input type="text" id="name" name="name" value="{{$role->name}}" class="input w-full border mt-2" placeholder="Enter Role Name">
                          
                      </div>

                      <div>
                          <label for="description"> Describe Role</label>
                          <textarea name="description" id="" cols="30" rows="10" value="{{$role->description}}" class ="input w-full border mt-2" placeholder = "Describe Role"></textarea>                          
                      </div>

        ...
        <div class="card-content p-2">
         ...
         <div class="card-title text-uppercase text-center py-3">Add LGA</div>
          ...
          @endif 
           ...
           <form method = "post" action = "{{ route('dashboard.lga.store') }}">
              @csrf
             ...
             <label for="state" class="sr-only">State</label>
              <div class="position-relative has-icon-right">
              <input type="text" id="name" name = "name" class="form-control input-shadow" placeholder="Enter LGA Name">
              </div>
             </div>
             
             
               <button type="submit" class="btn btn-primary btn-block" >Add LGA</button>

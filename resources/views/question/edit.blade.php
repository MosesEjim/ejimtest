      ...
      <div class="intro-y col-span-12 lg:col-span-12">
          ...
          <div class="intro-y box">
              <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                  ...
                  Editing : {{ $question->question_text }}
                  </h2>
              </div>
                ...
                <form method="post" action="{{ route('dashboard.uem.question.update', $question->slug) }}">
                  ...
                  <div class="preview">
                      <div>
                          ...
                          <input type="text"  id="question_text" name="question_text" value="{{ $question->question_text }}" class="input w-full border mt-2" placeholder="Enter Question" required>
                      </div>
                      <input type="hidden" name="survey_type_id" value="{{$question->id}}">
                      <div class="mt-3">

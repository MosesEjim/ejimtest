   ...
   <div class="card card-authentication1 mx-auto my-5">
       <div class="card-body">
        <div class="card-content p-2">
         ...
         <div class="card-title text-uppercase text-center py-3">Edit A Product</div>
           ...
           <form method = "post" action = "{{ route('dashboard.product.update', $product->id) }}">
             ...
             <label for="product_name" class="sr-only">Product Name</label>
              <div class="position-relative has-icon-right">
                 <input type="text" id="product_name" name ="product_name" value = "{{ $product->product_name }}"class="form-control input-shadow" placeholder="Enter Product Name">
              </div>
             </div>
             <div class="form-group">
             <label for="brand" class="sr-only">Brand Name</label>
              <div class="position-relative has-icon-right">
                 <input type="text" id="brand" name = "brand" value = "{{ $product->brand }}" class="form-control input-shadow" placeholder="Enter Brand Name">
              </div>
             </div>
             <div class="form-group">
             <label for="material_no" class="sr-only">Material Number</label>
              <div class="position-relative has-icon-right">
                 <input type="text" id="material_no" name = "material_no" value = "{{ $product->material_no }}" class="form-control input-shadow" placeholder="Enter Material Number">
              </div>
             </div>
             <div class="form-group">
             <label for="batch_no" class="sr-only">Batch Number</label>
              <div class="position-relative has-icon-right">
                 <input type="text" id="batch_no" name = "batch_no" value = "{{ $product->batch_no }}" class="form-control input-shadow" placeholder="Enter Batch Number">
              </div>
             </div>
             <div class="form-group">

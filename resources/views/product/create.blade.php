              ...
              <form method="post" action="{{ route('dashboard.product.store') }}">
                  ...
                  <div class="preview">
                      <div>
                          ...
                          <input type="text" id="product_name" name ="product_name" class="input w-full border mt-2" placeholder="Enter Product Name" required>
                      </div>
                      <div>
                          <label for="brand"> Brand</label>
                          <input type="text" id="brand" name = "brand" class="input w-full border mt-2" placeholder="Enter Brand Name">
                      </div>
                      <div>
                          <label for="material_no"> Material No</label>
                          <input type="text" id="material_no" name = "material_no" class="input w-full border mt-2" placeholder="Enter Material Number">
                      </div>
                      <div>
                          <label for="batch_no"> Batch No</label>
                          <input type="text" id="batch_no" name = "batch_no" class="input w-full border mt-2" placeholder="Enter Batch Number">
                      </div>

                ...
                <form method="POST" action="{{route('dashboard.eum.program.update', $program->id)}}">
                    ...
                    <div class="preview">
                        <div>
                            ...
                            <input type="text"  id="name" name="name" value="{{$program->name}}" class="input w-full border mt-2" placeholder="Educations" required>
                        </div>
                        </div>
                        <button type="submit" class="button bg-theme-1 text-white mt-5">Update Program</button>
                    </div>
                  </form>
                </div>
            </div>

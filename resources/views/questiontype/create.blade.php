...
@section('title', 'Create Question Type')
        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            ...
            <div class="intro-y box">
                ...
                @endif 
                  ...
                  <form method="post" action="{{route('dashboard.question.type.store')}}">
                    @csrf
                    <div class="preview">
                        <div>
                            <label>Type</label>
                            <input type="text"  id="type" name = "type" class="input w-full border mt-2" placeholder="Enter Type" required>
                        </div>
                        </div>

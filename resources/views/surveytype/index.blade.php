                          ...
                          <tr class="intro-x">
                              ...
                              <td class="table-report__action w-56">
                                  <div class="flex justify-center items-center">
                                      ...
                                      <a class="flex items-center mr-3" href="{{ route('dashboard.eum.questionnaire.create', $surveytype->id) }}"> <i data-feather="check-square" class="w-4 h-4 mr-1"></i> Create Survey </a>

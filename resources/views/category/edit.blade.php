              ...
              <form method="post" action="{{ route('dashboard.category.update', $category->id) }}">
                  ...
                  <div class="preview">
                      <div>
                          ...
                          <input type="text"  id="title" name="title" value="{{$category->title}}" class="input w-full border mt-2" placeholder="Enter Category Name" required>
                      </div>
                      
                      <div class="mt-3">
                          <label for="description">Program</label>
                          <textarea name="description" id="description" value="{{$category->description}}" cols="30" rows="10" class="input w-full border mt-2" placeholder="Enter Category Description"></textarea>
                      </div>

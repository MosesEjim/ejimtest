   ...
   <div class="card card-authentication1 mx-auto my-5">
       <div class="card-body">
        <div class="card-content p-2">
         ...
         <div class="card-title text-uppercase text-center py-3">Update A Subcategory</div>
           ...
           <form method = "post" action = "{{ route('dashboard.eum.subprogram.update', $subprogram->id) }}">
             ...
             <label for="lga" class="sr-only">LGA</label>
              <div class="position-relative has-icon-right">
               ...
               <button type="submit" class="btn btn-primary btn-block" >Update SubProgram</button>
...
@endsection
          @endif 
           ...
           <form method = "post" action = "{{ route('dashboard.eum.program.update', $subprogram->id) }}">
              @csrf
              @method("PUT")
             <div class="form-group">
             <label for="name" class="sr-only">Sub category name</label>
              <div class="position-relative has-icon-right">
                 <input type="text" id="name" name = "name" class="form-control input-shadow" placeholder="Enter Sub Category Name">
              </div>
             </div>

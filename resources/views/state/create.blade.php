   ...
   <div class="card card-authentication1 mx-auto my-5">
       <div class="card-body">
        <div class="card-content p-2">
         ...
         <div class="card-title text-uppercase text-center py-3">Add A State</div>
           ...
           <form method = "post" action = "{{ route('dashboard.state.store') }}">
             ...
             <label for="product_name" class="sr-only">State Name</label>
              <div class="position-relative has-icon-right">
                 <input type="text" id="name" name ="name" class="form-control input-shadow" placeholder="Enter State Name">
              </div>
             </div>

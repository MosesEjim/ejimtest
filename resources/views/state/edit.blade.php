              ...
              <form method="post" action="{{ route('dashboard.state.update', $state->id) }}">
                  ...
                  <div class="preview">
                      <div>
                          ...
                          <input type="text" id="name" name ="name" value="{{$state->name}}" class="input w-full border mt-2" placeholder="Enter State Name">
                      </div>
            
                      <button type="submit" class="button bg-theme-9 text-white mt-5 mr-5">Save State</button>
                  </div>
                </form>
              </div>
          </div>

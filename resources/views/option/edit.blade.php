      ...
      <div class="intro-y col-span-12 lg:col-span-8">
          ...
          <div class="intro-y box">
              <div class="flex flex-col sm:flex-row items-center p-5 border-b border-gray-200">
                  ...
                  Editing Option to : {{ $option->question->question_text }}
                  </h2>
              </div>
              ...
              <form method="post" action="{{ route('dashboard.eum.option.update', $option->slug) }}">
                  @csrf
                  @method('PUT')
                  <div class="preview">
                      <div>
                          <label for="option">Option Text</label>
                          <input type="text"  id="option" name="option" value="{{$option->option}}" class="input w-full border mt-2"  required>
                      </div>
                      <div class="mt-3">
